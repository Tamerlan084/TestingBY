...
public class EditMainInformation {
  ...
  public void testEditMainInformation() throws Exception {
    ...
    driver.findElement(By.name("lastName")).sendKeys("Zhabassov");
    driver.findElement(By.name("firstName")).clear();
    driver.findElement(By.name("firstName")).sendKeys("Kasimbek");
    driver.findElement(By.name("nativeName")).clear();
    driver.findElement(By.name("nativeName")).sendKeys("Energetik");
    driver.findElement(By.name("mobilePhone")).clear();
    driver.findElement(By.name("mobilePhone")).sendKeys("9969371406");
